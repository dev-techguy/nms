...
class DriverController extends Controller
{
    ...
    public function index()
    {
        $users = User::whereHas('roles', function ($query) {
            return $query->whereIn('name', ['Driver']);
        })->get();
        return view('drivers.index')->with('users', $users);
    }
    ...
    public function store(Request $request)
    {
        ...
        $user->assignRole('Driver'); //Assigning role to user
    ...
    public function edit($id)
    {
        ...
        return view('drivers.edit', compact('user')); //pass user and roles data to view
    }
