...
$(document).ready(function() {
	...
	if($('#area_chart').length > 0) {
        ...
        lineWidth:0,
		fillOpacity: 0.95,
		pointStrokeColors:['#97ca5a','#2d3192'],
		behaveLikeLine: true,
		grid: false,
		hideHover: 'auto',
		lineColors: ['#97ca5a','#2d3192'],
		resize: true,
		redraw: true,
		smooth: true,
	...
	if( $('#m_chart_4').length > 0 ){
		...
		var lineChart = Morris.Line({
				...
				pointStrokeColors: ['#2d3192','#97ca5a','#aed67e'],
				lineColors: ['#2d3192','#97ca5a','#aed67e'],
			});
	}
