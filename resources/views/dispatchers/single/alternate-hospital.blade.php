...
@section('title', 'Case Alternative Hospital')
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xl-12 pa-0">
            ...
            @include('dispatchers.single.casenav', ['active' => 'alternate-hospital'])
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <section class="hk-sec-wrapper">
                                <h5 class="hk-sec-title">Alternative Hospital</h5>
                                <form method="POST" action="{{route('cases.dispatch.store.alternate-hospital', $case)}}" role="form">
                                    @csrf
                                    <div class="form-group">
                                        <label for="alternative_health_facility">Health Facility</label>
                                        <input type="text" name="alternative_health_facility" class="form-control @error('alternative_health_facility') is-invalid @enderror" id="alternative_health_facility" value="{{ $case->alternative_health_facility }}" required=""  placeholder="Enter Facility">
                                        @error('alternative_health_facility')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
