...
<div class="container">
    ...
    <div class="row">
        <div class="col-xl-12 pa-0">
            ...
            @include('dispatchers.single.casenav', ['active' => 'details'])
                ...
                <div class="tab-pane fade show active" role="tabpanel">
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="hk-pg-header">
                            <div>
                                <h5 class="hk-pg-title">Case Details</h5>
                            </div>
                            <div class="d-flex">
                                <a href="{{ route('cases.dispatch.hospital', $case) }}" class="btn btn-danger btn-sm btn-wth-icon icon-wthot-bg icon-right">
                                    <span class="btn-text">Proceed</span>
                                    <span class="icon-label"><i class="fa fa-long-arrow-right"></i> </span>
                                </a>
                            </div>
                        </div>
                        <!-- /Title -->
