        ...
        <div class="hk-pg-header">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                data-feather="list"></i></span></span>Cases Report</h4>
            </div>
            <div class="d-flex">
                <a href="{{ route('watchers.report.cases.pdf') }}" class="btn btn-primary btn-wth-icon icon-wthot-bg"
                   target="_blank">
                    <span class="icon-label"><i class="fa fa-file-pdf-o"></i> </span>
                    <span class="btn-text">Download PDF</span>
                </a>
                <a href="{{ route('watchers.report.cases.excel') }}"
                   class="btn btn-info btn-wth-icon icon-wthot-bg ml-4" target="_blank">
