        ...
        <div class="row">
            <div class="col-md-12">
                <section class="hk-sec-wrapper">
                    <h5 class="hk-sec-title">Create New Single Casualty Case</h5>
                    <form method="POST" action="{{ route('incidents.store') }}" role="form">
                        @csrf
                        <input type="hidden" value="No" name="mass_casualty_incident" id="mass_casualty_incident">
                        ...
                        <div class="form-group">
                            ...
                            <select name="sub_county" id="sub_county"
                                ...
                                <option
                                    value="Dagoretti North" {{ 'Dagoretti North'==old('sub_county')?'selected':'' }}>
                                    Dagoretti North
                                </option>
                                <option
                                    value="Dagoretti South" {{ 'Dagoretti South'==old('sub_county')?'selected':'' }}>
                                    Dagoretti South
                                </option>
                                ...
                                <option value="Embakasi North" {{ 'Embakasi North'==old('sub_county')?'selected':'' }}>
                                    Embakasi North
                                </option>
                                <option
                                    value="Embakasi Central" {{ 'Embakasi Central'==old('sub_county')?'selected':'' }}>
                                    Embakasi Central
                                </option>
                                <option value="Embakasi South" {{ 'Embakasi South'==old('sub_county')?'selected':'' }}>
                                    Embakasi South
                                </option>
                                ...
                                <option value="Kibera" {{ 'Kibera '==old('sub_county')?'selected':'' }}>Kibera
                                </option>
                                ...
                                <option value="Roysambu" {{ 'Roysambu'==old('sub_county')?'selected':'' }}>Roysambu
                                </option>
                                <option value="Starehe" {{ 'Starehe'==old('sub_county')?'selected':'' }}>Starehe
                                </option>
                                <option value="Mathare" {{ 'Mathare'==old('sub_county')?'selected':'' }}>Mathare
                                </option>
                        ...
                        <div class="partial-block">
                            <div class="form-group">
                                ...
                                <input type="text" name="patient_name"
                                       ...
                                       id="patient_name" value="{{ old('patient_name') }}" required="">
                                @error('patient_name')
                                <div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="form-group">
                                ...
                                <select name="patient_age" id="patient_age"
                                    ...
                                    @for ($i = 1; $i < 120; $i++)
                                        <option
                                            value="{{ $i }}" {{ $i==old('patient_age')?'selected':'' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                                @error('patient_age')
                                <div class="invalid-feedback">{{ $message }}</div>@enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="patient_gender" id="patient_gender"
                                    ...
                                    <option value="Male" {{ 'Male'==old('patient_gender')?'selected':'' }}>Male</option>
                                    <option value="Female" {{ 'Female'==old('patient_gender')?'selected':'' }}>Female
                                    </option>
                                    <option value="Others" {{ 'Others'==old('patient_gender')?'selected':'' }}>Others
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="patient_nhif_insurance_data">Patients Insurance Data i.e NHIF</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="patient_next_of_kin"
                                       ...
                                       id="patient_next_of_kin" value="{{ old('patient_next_of_kin') }}">
