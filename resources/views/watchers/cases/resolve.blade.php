    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="lock"></i></span></span>Resolve Case</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <section class="hk-sec-wrapper">
                    ...
                    <form method="POST" action="{{route('incidents.resolve', $incident)}}" role="form">
                        @csrf

                        <div class="form-group">
                            <label for="watcher_comments">Comments</label>
                            <textarea name="watcher_comments" rows="6"
                                      class="form-control @error('watcher_comments') is-invalid @enderror"
                                      required="">{{ $incident->watcher_comments }}</textarea>
