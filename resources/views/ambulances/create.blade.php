                                ...
                                <form action="{{route("ambulances.store")}}" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-row">
                                            <div class="form-group col-md-4" {{ $errors->has('dispatch_center_id') ? 'has-error' : '' }}>
                                                ...
                                                <select class="form-control select2" id="dispatch_center_id" name="dispatch_center_id" required>
                                                    <option value="">-- Select Emergency Care Center --</option>
                                                    @foreach($data as $key => $dispatch)
                                                        <option value="{{$dispatch->id}}">{{$dispatch->emergency_center->name}} ({{$dispatch->location}})</option>
                                                    @endforeach
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('basic_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="basic_stats" name="basic_stats" type="text" class="form-control" placeholder="basic_stats" required>
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('advanced_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="advanced_stats" name="advanced_stats" type="text" class="form-control" placeholder="advanced_stats" required>
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('EMTs_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="EMTs_stats" name="EMTs_stats" type="text" class="form-control" placeholder="EMTs_stats" required>
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('driver_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="driver_stats" name="driver_stats" type="text" class="form-control" placeholder="driver_stats" required>
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('shift_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="shift_stats" name="shift_stats" type="text" class="form-control" placeholder="shift_stats" required>
                                        ...
                                        <div class="form-group col-md-4" {{ $errors->has('staff_per_shift_stats') ? 'has-error' : '' }}>
                                            ...
                                            <input id="staff_per_shift_stats" name="staff_per_shift_stats" type="text" class="form-control" placeholder="staff_per_shift_stats" required>
