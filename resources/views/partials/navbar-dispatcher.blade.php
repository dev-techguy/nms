    ...
    <div class="nicescroll-bar">
        <div class="navbar-nav-wrap container">
            <ul class="navbar-nav @yield('navbardirection', 'flex-column')">
                @can('Read Dispatchers Panel')
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dispatchers.dashboard')}}" >
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('dispatchers.realtime')}}" >
                        <span class="feather-icon"><i data-feather="activity"></i></span>
                        <span class="nav-link-text">Realtime</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('cases.allcases') }}" >
                        <span class="feather-icon"><i data-feather="target"></i></span>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="{{route('dispatchers.report')}}" >
