...
<nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
    ...
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img class="brand-img d-inline-block" src="{{ asset('images/namsip-logo.png') }}" height="34" alt="brand" />
        </a>
        <div class="navbar-text ">
            <h6> Nairobi Metropolitan</h6>
            <small>Emergency Management System</small>
        </div>
       ...
       <ul class="navbar-nav hk-navbar-content">
                ...
                <div class="notifications-nicescroll-bar">
                        ...
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar avatar-sm">
                                    <img src="{{ asset('img/avatar1.jpg') }}" alt="user" class="avatar-img rounded-circle">
                                </div>
                            </div>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar avatar-sm">
                                    <img src="{{isset(Auth::user()->avatar) ? Storage::url(Auth::user()->avatar) : asset('img/avatar2.jpg') }}" alt="user" class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body">
                                <div>
        ...
        <li class="nav-item dropdown dropdown-authentication">
            ...
            <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                <a class="dropdown-item" href="{{ route('profile.show') }}"><i class="dropdown-icon zmdi zmdi-account"></i><span>Profile</span></a>
                ...
                <a class="dropdown-item" href="{{ url('/logout') }}"
                    onclick="event.preventDefault();
                         ...
                         <i class="dropdown-icon zmdi zmdi-power"></i><span>Logout</span>
                </a>
