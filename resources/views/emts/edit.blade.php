...
<div class="container">
    ...
    <div class="hk-pg-header">
        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="edit-2"></i></span></span>Edit EMT</h4>
    </div>
    <!-- /Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="hk-sec-wrapper">
                <h5 class="hk-sec-title">Edit EMT Details</h5>
                <form method="POST" action="{{route('emts.update', $user->id)}}" role="form">
                    @method('PUT')
                    @csrf
