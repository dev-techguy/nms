...
@if(session('info'))
    <div class="alert alert-info alert-dismissible fade show mb-0" role="alert" wire:ignore>
...
@if(session('primary'))
    <div class="alert alert-primary alert-dismissible fade show" role="alert" wire:ignore>
